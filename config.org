#+TITLE: channel-42s GNU Emacs Config
#+AUTHOR: channel-42
#+STARTUP: overview 
...
* About
My emacs config, adopted from [[https://gitlab.com/dwt1/dotfiles/-/blob/master/.emacs.d.gnu/config.org][DT's emacs config]]. This config is oriented towards efficient note-taking with org-mode and general
