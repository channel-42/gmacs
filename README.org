...
#+HTML:<div align=center><a href="https://github.com/channel-42/gmacs"><img alt="gmacs Logo" width="400" src="https://github.com/channel-42/gmacs/blob/master/lmbd_macs.png"></a>
...
(use-package dashboard
  ...
  (setq dashboard-set-heading-icons t
        ...
        ;; custom header image 
        dashboard-startup-banner "~/.emacs.d/lmbd_macs.png"
...
#+begin_src emacs-lisp
(defvar gmacs/compile-command "cmake . && make -j4 && ./bin/*"
