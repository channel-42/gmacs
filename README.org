...
(use-package org-tempo
  ...
  :ensure nil
  :config
  (add-to-list 'org-structure-template-alist '("cp" . "src cpp :noweb yes"))
  (add-to-list 'org-structure-template-alist '("c" . "src c :noweb yes")))
#+end_src
...
#+begin_src emacs-lisp
(defvar gmacs/compile-command "cd build && cmake .. && make -j4 && ./bin/*"
